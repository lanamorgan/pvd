...
public class HashCube extends GenericCube {
  ...
  public HashCube(RelOptCluster cluster, RelTraitSet traitSet,
    ...
    for(AggregateCall agg: aggCalls){
      assert(agg.getAggregation() == SqlStdOperatorTable.COUNT);
    }
  }
  //~ Methods ----------------------------------------------------------------
  @Override public HashCube copy(RelTraitSet traitSet, RelNode input,
